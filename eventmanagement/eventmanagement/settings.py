...
SECRET_KEY = 'django-insecure-4j&mlm$ptcem@di-!b8zbtt+v^bea+)=y&80o3z%omyslhba_l'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS =  ['127.0.0.1', 'localhost', 'aurabooking']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER':'postgres',
        'PASSWORD':'kYbRHZDilFlfmEhDXTKmvgAsNsCxbpxg',
